...
app.factory('dataService', ['$http', 'config', 'formatFilter', function($http, config, formatFilter) {
    ...
    function getRelatedPostsByTopic(params, callback) {
        var serviceKey = 'related_posts';
        var options = {
            method: 'GET',
            params: params,
    ...
    function getRelatedTopics(params, callback) {
        var serviceKey = 'ralated_topics';
    ...
    exports = {
        ...
        getRelatedPostsByTopic: getRelatedPostsByTopic,
